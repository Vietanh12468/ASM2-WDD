...
<body>
    ...
    <h1> Welcome To Admin Mode</h1>
        <button onclick="document.getElementById('1').style.display='block'">Tour manager</button>
        <button onclick="document.getElementById('2').style.display='block'">Account manager</button>
        <button onclick="document.getElementById('3').style.display='block'">Category manager</button>
    </div>
